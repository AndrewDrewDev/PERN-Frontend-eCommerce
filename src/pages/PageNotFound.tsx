...
const PageNotFound: FC<TPageNotFound> = ({ title, message }): ReactElement => {
  const Logo: FC = () => {
    return (
      <svg
        id="prefix__Layer_1"
      ...
      >
        <defs>
          <style>
            {
              '.prefix__cls-10,.prefix__cls-13,.prefix__cls-14,.prefix__cls-15,.prefix__cls-17,.prefix__cls-5,.prefix__cls-6{stroke:#000}.prefix__cls-13,.prefix__cls-14,.prefix__cls-8{stroke-linecap:round;stroke-linejoin:round}.prefix__cls-10,.prefix__cls-12,.prefix__cls-13,.prefix__cls-14,.prefix__cls-15,.prefix__cls-17,.prefix__cls-3,.prefix__cls-5,.prefix__cls-6,.prefix__cls-7,.prefix__cls-8,.prefix__cls-9{stroke-width:3px}.prefix__cls-10,.prefix__cls-12,.prefix__cls-15,.prefix__cls-17,.prefix__cls-3,.prefix__cls-5,.prefix__cls-6,.prefix__cls-7,.prefix__cls-9{stroke-miterlimit:10}.prefix__cls-3{fill:#818181}.prefix__cls-12,.prefix__cls-3,.prefix__cls-7,.prefix__cls-8,.prefix__cls-9{stroke:#191818}.prefix__cls-5{fill:#4ea7f1}.prefix__cls-14,.prefix__cls-6{fill:#f8f3ed}.prefix__cls-7{fill:#333}.prefix__cls-13,.prefix__cls-8{fill:none}.prefix__cls-9{fill:#f8f59c}.prefix__cls-10{fill:#f3d2c9}.prefix__cls-15{fill:#8bb174}.prefix__cls-17{fill:#da4e22}'
            }
          </style>
        </defs>
        <path
        ...
        />
        <path className="prefix__cls-8" d="M1560.5 1428.5s69-32 85-94" />
        <path
          className="prefix__cls-7"
        ...
        <ellipse
          ...
          ry={117}
        />
        <circle className="prefix__cls-9" cx={1355} cy={991} r={31.5} />
        <path
        ...
        <path
          ...
          stroke="#000"
        />
        <circle className="prefix__cls-12" cx={1355} cy={991} r={22.5} />
        <circle className="prefix__cls-9" cx={1557} cy={991} r={31.5} />
        <circle className="prefix__cls-12" cx={1557} cy={991} r={22.5} />
        <path
          className="prefix__cls-10"
        ...
        />
        <circle className="prefix__cls-9" cx={395.47} cy={335.18} r={65.13} />
        <path
          className="prefix__cls-17"
  ...
  return (
    <div className="flex justify-center my-20 flex items-center">
      <div
      ...
      >
        <div className="max-w-md">
          ...
          <p className="mb-8">
            {message
              ? message
              : 'Но не волнуйтесь, вы можете найти много других вещей на нашей домашней странице.'}
          </p>

          <Link
            to="/"
            className="px-4 inline py-2 text-sm font-medium leading-5 shadow
            text-white transition-colors duration-150 border border-transparent
            rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600

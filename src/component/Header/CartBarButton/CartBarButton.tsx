...
const CartBarButton: FC<THeaderCartBarButton> = observer(
  ({ onClick }): ReactElement => {
    ...
    return (
      <div className="relative flex items-center justify-end w-full">
        <button
          className="fixed p-1 duration-500 hover:bg-blue-500 border-2
          border-blue-600 shadow hover:shadow-lg focus:outline-none sm:mx-0
          rounded-full flex items-center justify-center bg-blue-600 text-white
          z-30"
          onClick={onClick}
        >
          <svg
          ...
          item ? (
            ...
            >
              ...
              <div className="-mx-3 py-2 px-4">
                <div className="mx-3">
                  <span className="text-green-500 font-semibold truncate">
                    Добавлено в Корзину
                  </span>

        ...
        <div className="p-5 w-48">
          ...
          <div className="mt-4 grid grid-cols-4 gap-1 fill-current text-gray-600 items-center">
            <a className="cursor-pointer hover:text-gray-400" href="#">
              ...
              >
                <path d="M28.6.6L.9 11.6c-.9.3-.8 1.6.1 1.9l7 2.2 2.8 8.8c.2.7 1.1.9 1.6.4l4.1-3.8 7.8 5.7c.6.4 1.4.1 1.6-.6L31.3 3c.3-1.7-1.2-3-2.7-2.4zM12.4 17.4l-.9 5.2-2-7.2L29 2.6 12.4 17.4z"></path>
              </svg>{' '}
            </a>
            ...
            >
              <path d="M3.966 7.36C3.966 8.317 4 13 4 13H0v6l3.966-.011L4 38h8V19l5.124-.011s.387-2.635.626-5.989H12s-.13-4.155-.13-4.807c0-.653.858-1.533 1.707-1.533h4.29V0h-5.833C3.772 0 3.966 6.403 3.966 7.36z"></path>
            </svg>{' '}
            <svg
              className="cursor-pointer hover:text-gray-400"
              width="20pt"
            ...
            >
              <path d="M9.3 16c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8zm0-12.2C7 3.8 5.1 5.7 5.1 8s1.9 4.2 4.2 4.2 4.2-1.9 4.2-4.2-1.9-4.2-4.2-4.2z"></path>
              <path d="M17.9 16.8c-.7-.9-1.9-1-2.8-.4 0 0-2.2 1.6-5.8 1.6-3.6 0-5.8-1.6-5.8-1.6-.9-.7-2.1-.5-2.8.4-.7.9-.5 2.1.4 2.8.1.1 2.2 1.7 5.7 2.2l-5.3 5.4c-.8.8-.8 2.1 0 2.8.4.4.9.6 1.4.6.5 0 1-.2 1.4-.6l5-5.1 5 5.1c.4.4.9.6 1.4.6.5 0 1-.2 1.4-.6.8-.8.8-2 0-2.8l-5.3-5.4c3.5-.6 5.6-2.2 5.7-2.2.9-.7 1.1-2 .4-2.8z"></path>
            </svg>{' '}
            <svg
              className="cursor-pointer hover:text-gray-400"
              width="20pt"
